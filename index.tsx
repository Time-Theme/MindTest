...
const PsychologyAssessmentWebsite = () => {
  ...
  const scales = {
    ...
    'psqi': {
      ...
      items: [
        ...
        { id: 8, text: '做噩梦' },
        { id: 9, text: '疼痛不适' },
        { id: 10, text: '总的来说，您的睡眠质量如何？' },
        { id: 11, text: '您是否服用药物来帮助睡眠？' },
        { id: 12, text: '您是否因为困倦而难以保持清醒？' }
      ],
      options: [
        { value: 0, text: '过去一个月没有/非常好', color: '#10B981' },
        { value: 1, text: '少于每周1次/比较好', color: '#F59E0B' },
        { value: 2, text: '每周1-2次/比较差', color: '#EF4444' },
        { value: 3, text: '每周3次或以上/非常差', color: '#DC2626' }
      ],
      scoring: {
        ranges: [
          ...
          { min: 16, max: 36, level: '睡眠质量很差', description: '睡眠质量很差，强烈建议寻求专业医疗帮助', color: '#DC2626' }
        ]
      },
      dimensions: [
        { name: '睡眠障碍', items: [1, 2, 3, 4, 5, 6, 7, 8, 9], color: '#EF4444' },
        { name: '睡眠质量', items: [10], color: '#3B82F6' },
        { name: '日间功能', items: [11, 12], color: '#EC4899' }
      ]
    },
    ...
    'sds': {
      ...
      scoring: {
        ranges: [
          ...
          { min: 48, max: 55, level: '中度抑郁', description: '存在中度抑郁症状，建议寻求专业帮助', color: '#EF4444' },
  ...
  const cancelSubmit = () => {
    setShowSubmitDialog(false);
    setCurrentQuestion(currentScale.items.length - 1);
  };
        ...
        <div className="container mx-auto px-6 py-8 max-w-3xl">
          ...
          {showSubmitDialog && (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 transform transition-all animate-in slide-in-from-bottom-4">
